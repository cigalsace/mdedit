    ...
    if (keywords) {
        keywords.forEach( function(keyword, key) {
            if (keyword) {
                ...
                if (keyword.type) {
                    xml += '<gmd:type><gmd:MD_KeywordTypeCode codeListValue="' + keyword.type + '" codeList="http://www.isotc211.org/2005/resources/codeList.xml#md_KeywordTypeCode" /></gmd:type>\n';
                }
...
function json2xml(metadata) {
    ...
    if (metadata.data_keywords_list) {
        data_keywords_error = 0;
        metadata.data_keywords_list.forEach( function(keyword, key) {
            var data_keyword = {
