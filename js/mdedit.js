...
mdEdit.controller('mdEditCtrl', ['$scope', '$http', '$sce',  '$modal', '$log', function ($scope, $http, $sce,  $modal, $log) {
    /*
    ...
    */
    ...
    // Get locales
    $http.get('json/locales-'+config.userLang+'.json').success(function(data) {
        $scope.ui = data.ui;
        $scope.fields = data.fields;
        $scope.codelists = data.codelists;
    ...
    $scope.addGeographicExtent = function () {
        ...
        $scope.metadata.data_geographicextents.push(empty_geographicextent);
    };
    ...
    $scope.addBrowsegraphic = function () {
        ...
        $scope.metadata.data_browsegraphics.push(empty_browsegraphic);
    };
    ...
    $scope.addTemporalextent = function () {
        ...
        $scope.metadata.data_temporalextents.push(empty_temporalextent);
    };
    // Add / remove keyword
    ...
    $scope.addKeyword = function () {
        ...
        $scope.metadata.data_keywords.push(empty_keyword);
    };
    ...
    $scope.addReferencesystem = function () {
        ...
        $scope.metadata.data_referencesystems.push(empty_referencesystem);
    };
    ...
    $scope.addFormat = function () {
        ...
        $scope.metadata.data_distformats.push(empty_format);
    };
    ...
    $scope.addInspireConstraint = function () {
        ...
        $scope.metadata.data_legal_accessinspireconstraints.push(empty_constraint);
    };
    ...
    $scope.addAccessConstraint = function () {
        var empty_constraint = '';
        $scope.metadata.data_legal_accessconstraints.push(empty_constraint);
    ...
    $scope.addUseConstraint = function () {
        var empty_constraint = '';
        $scope.metadata.data_legal_useconstraints.push(empty_constraint);
    };
    ...
    $scope.addUseLimitation = function () {
        ...
        $scope.metadata.data_legal_uselimitations.push(empty_limitation);
    };
    // Add / remove linkage
    ...
    $scope.addLinkage = function () {
        ...
        $scope.metadata.data_linkages.push(empty_limitation);
    };
    ...
    */
    ...
    $http.get('json/lst_geographicextents.json').success(function(data) {
